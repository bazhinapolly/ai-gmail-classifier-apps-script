...
def build_case_study():
    story = [
        ...
        p("Business value", "h2"),
        p("The workflow is designed to reduce repetitive inbox triage, keep ambiguous cases visible, preserve the user's normal email state, and provide a controlled foundation for account-specific categories and policies."),
    ]
